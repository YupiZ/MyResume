...
function Home({ name, subtitles = [] }) {
    ...
    return (
        <main
            className="flex min-h-screen flex-col items-center bg-gradient-to-b from-gray-100 via-white to-gray-200 bg-cover bg-center px-6 text-gray-900 md:px-12"
            style={{ backgroundImage: `url(${'/images/bg.jpg'})` }}
        >
            <div className="mb-8 mt-64 text-center">
                <h1 className="text-3xl font-bold leading-tight text-blue-600 sm:text-4xl md:text-5xl">
                    {name}
                </h1>
                <p className="text-md mt-2 italic text-white sm:text-lg md:text-xl">
                    {currentSubtitle}
                </p>
            </div>
